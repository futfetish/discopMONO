...
// TODO: Разделить сущности друзей и пользователей
export const usersRouter = createTRPCRouter({
  ...
  friend_accept: protectedProcedure
    .input(
      z.object({
        id: z.string(),
      }),
  ...
  friend_reject: protectedProcedure
    .input(
      z.object({
        id: z.string(),
      }),
  ...
  friend_cancel: protectedProcedure
    .input(
      z.object({
        id: z.string(),
      }),
